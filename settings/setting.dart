...
class SettingPage extends StatefulWidget {
  ...
  @override
  SettingPage(Utilisateur user){this.user= user ; }
  _SettingPageState createState() => _SettingPageState(user);
}

class _SettingPageState extends State<SettingPage>{
  Utilisateur utilisateur ;
  _SettingPageState(Utilisateur utilisateur) {this.utilisateur = utilisateur ;}
            ...
            children: <Widget>[
              ...
              Row(
                children:<Widget>[
                  ...
                  Text(utilisateur.sharableUserInfo.displayName, style: TextStyle( fontSize: 30,color: Color(0xff739D84),)),
                ],),
            ],
          ),
        ),
